...
public class SceneIntermediateControllerScript : MonoBehaviour {
	...
	public void LoadNextSceneAdditiveWithTransition () {
		...
		STSTransitionController.LoadScene (m_NextSceneName , LoadSceneMode.Additive, "SceneTransition", tTransitionDataScript);
	}
	...
	public void LoadNextSceneWithTransition () {
		...
		STSTransitionController.LoadScene (m_NextSceneName , LoadSceneMode.Single, "SceneTransition", tTransitionDataScript);
	}
	...
	public void StandByIsStarted(STSTransitionData sTransitionDataScript)
	{
		Debug.Log ("StandByIsStarted");
	}

	public void StandByIsFinished(STSTransitionData sTransitionDataScript)
	{
	...
	public void GoToNextScene()
	{
		...
		STSTransitionController.FinishStandBy ();
	}
}
