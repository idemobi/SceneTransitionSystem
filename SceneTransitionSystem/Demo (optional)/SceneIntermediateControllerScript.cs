...
public class SceneIntermediateControllerScript : MonoBehaviour {
	...
	public void LoadNextSceneAdditiveWithTransition () {
		...
		IDETransitionControllerScript.LoadSceneByName (m_NextSceneName , LoadSceneMode.Additive, "SceneTransition", tTransitionDataScript);
	}
	...
	public void LoadNextSceneWithTransition () {
		...
		IDETransitionControllerScript.LoadSceneByName (m_NextSceneName , LoadSceneMode.Single, "SceneTransition", tTransitionDataScript);
	}
	...
	public void LoadIntermediateScene(IDETransitionDataScript sTransitionDataScript)
	{
	...
	public void StandByIsStarted(IDETransitionDataScript sTransitionDataScript)
	{
		Debug.Log ("StandByIsStarted");
	}

	public void StandByIsFinished(IDETransitionDataScript sTransitionDataScript)
	{
	...
	public void GoToNextScene()
	{
		...
		IDETransitionControllerScript.FinishStandBy ();
	}
}
