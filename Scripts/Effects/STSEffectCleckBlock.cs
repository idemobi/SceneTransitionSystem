...
namespace SceneTransitionSystem
{
    ...
    [STSEightCross]
    // ***
    public class STSEffectClackBlock : STSEffect
    {
        //-------------------------------------------------------------------------------------------------------------
        ...
        public override void Draw(Rect sRect)
        {
            ...
            if (Purcent > 0)
            {
                ...
                {
                    tPurcentA = Purcent;
                    tPurcentB = (Purcent - 0.125F) / (1.00F - 0.125F);
                    //Debug.Log("Purcent =" + Purcent.ToString("F3"));
                ...
                else if (Purcent > 0.250F && Purcent <= 0.375F)
                {
                    tPurcentA = Purcent;
                    tPurcentB = (Purcent - 0.125F) / (1.00F - 0.125F);
                    tPurcentC = (Purcent - 0.250F) / (1.00F - 0.250F);
                    //Debug.Log("Purcent =" + Purcent.ToString("F3"));
                ...
                else if (Purcent > 0.375F && Purcent <= 0.500F)
                {
                    ...
                    tPurcentB = (Purcent - 0.125F) / (1.00F - 0.125F);
                    tPurcentC = (Purcent - 0.250F) / (1.00F - 0.250F);
                    tPurcentD = (Purcent - 0.375F) / (1.00F - 0.375F);
                    //Debug.Log("Purcent =" + Purcent.ToString("F3"));
                ...
                else if (Purcent > 0.500F && Purcent <= 0.625F)
                {
                    ...
                    tPurcentC = (Purcent - 0.250F) / (1.00F - 0.250F);
                    tPurcentD = (Purcent - 0.375F) / (1.00F - 0.375F);
                    tPurcentE = (Purcent - 0.500F) / (1.00F - 0.500F);
                    //Debug.Log("Purcent =" + Purcent.ToString("F3"));
                ...
                else if (Purcent > 0.625F && Purcent <= 0.750F)
                {
                    ...
                    tPurcentD = (Purcent - 0.375F) / (1.00F - 0.375F);
                    tPurcentE = (Purcent - 0.500F) / (1.00F - 0.500F);
                    tPurcentF = (Purcent - 0.625F) / (1.00F - 0.625F);
                    //Debug.Log("Purcent =" + Purcent.ToString("F3"));
                ...
                else if (Purcent > 0.750F && Purcent <= 0.875F)
                {
                    ...
                    tPurcentE = (Purcent - 0.500F) / (1.00F - 0.500F);
                    tPurcentF = (Purcent - 0.625F) / (1.00F - 0.625F);
                    tPurcentG = (Purcent - 0.750F) / (1.00F - 0.750F);
                    //Debug.Log("Purcent =" + Purcent.ToString("F3"));
                ...
                else
                {
                    ...
                    tPurcentF = (Purcent - 0.625F) / (1.00F - 0.625F);
                    tPurcentG = (Purcent - 0.750F) / (1.00F - 0.750F);
                    tPurcentH = (Purcent - 0.875F) / (1.00F - 0.875F);
                    //Debug.Log("Purcent =" + Purcent.ToString("F3"));
